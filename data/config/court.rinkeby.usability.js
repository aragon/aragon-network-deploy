...
module.exports = {
  ...
  court: {
    ...
    commitTerms:                   bn(96),                        // vote commits last 6 terms (2 days)
    revealTerms:                   bn(96),                        // vote reveals last 6 terms (2 days)
    appealTerms:                   bn(96),                        // appeals last 6 terms (2 days)
    appealConfirmTerms:            bn(96),                        // appeal confirmations last 6 terms (2 days)
  ...
  jurors: {
    token:                         ANJ,
    minActiveBalance:              bigExp(10000, ANJ.decimals),  // 100 ANJ is the minimum balance jurors must activate to participate in the Court
  },
  subscriptions: {
